...
<?php
  ...
  $q_string  = "select log_id,log_user,log_source,log_date,log_detail ";
  $q_string .= "from log ";
  $q_string .= $where;
  $q_string .= $orderby;
  $q_log = mysqli_query($db, $q_string) or die(header("Location: " . $Siteroot . "/error.php?script=" . $package . "&error=" . $q_string . "&mysql=" . mysql_error()));
