...
# Description: Delete association entries
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Shadowrunner)) {
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_accessory");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_active");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_adept");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_alchemy");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_ammo");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_bioware");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_commlink");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_complexform");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_cyberware");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_knowledge");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_language");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_license");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_lifestyle");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_mentor");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_program");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_qualities");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_spells");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_spirit");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_sprite");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from r_vehicles");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from runners");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from history");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from karma");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from street");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from notoriety");
      ...
      logaccess($db, $_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from publicity");
