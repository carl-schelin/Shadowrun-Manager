...
# now set to comma for the next item if any.
  ...
  $gear = "";
  $comma = "";
  $q_string  = "select r_gear_id,gear_name,gear_rating,r_gear_amount,r_gear_details ";
...
# associate any ammo with the weapon
  ...
  print "document.getElementById('pregen_mysql').innerHTML = '" . mysql_real_escape_string($output) . "';\n";
