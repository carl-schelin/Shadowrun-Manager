...
<table class="ui-styled-table" width="100%">
<tr>
  <th class="ui-state-default">Tradition Listing</th>
  <th class="ui-state-default" width="20"><a href="javascript:;" onmousedown="toggleDiv('tradition-listing-help');">Help</a></th>
</tr>
</table>

<div id="tradition-listing-help" style="<?php print $display; ?>">
