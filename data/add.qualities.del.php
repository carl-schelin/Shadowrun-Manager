...
# Description: 
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel(1)) {
      logaccess($_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from qualities");
