...
# Description: 
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel(1)) {
      logaccess($_SESSION['username'], $package, "Requesting record " . $formVars['id'] . " from rituals");
      ...
      print "document.dialog.rit_threshold.value = '"  . mysql_real_escape_string($a_rituals['rit_threshold']) . "';\n";
      print "document.dialog.rit_length.value = '"     . mysql_real_escape_string($a_rituals['rit_length'])    . "';\n";
      print "document.dialog.rit_duration.value = '"   . mysql_real_escape_string($a_rituals['rit_duration'])  . "';\n";
      print "document.dialog.rit_book.value = '"       . mysql_real_escape_string($a_rituals['rit_book'])      . "';\n";
      print "document.dialog.rit_page.value = '"       . mysql_real_escape_string($a_rituals['rit_page'])      . "';\n";
