...
<div id="actions-help" style="<?php print $display; ?>">
...
<table class="ui-styled-table" width="100%">
<tr>
  <th class="ui-state-default">Matrix Actions Listing</th>
  <th class="ui-state-default" width="20"><a href="javascript:;" onmousedown="toggleDiv('actions-listing-help');">Help</a></th>
</tr>
</table>

<div id="actions-listing-help" style="<?php print $display; ?>">
