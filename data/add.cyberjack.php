...
<table class="ui-styled-table" width="100%">
<tr>
  <th class="ui-state-default">Cyberjack Listing</th>
  <th class="ui-state-default" width="20"><a href="javascript:;" onmousedown="toggleDiv('cyberjack-listing-help');">Help</a></th>
</tr>
</table>

<div id="cyberjack-listing-help" style="<?php print $display; ?>">
