...
# Description: 
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel(1)) {
      ...
      $q_string  = "select life_style,life_comforts,life_necessities,life_security,life_neighborhood,life_entertainment,life_space,life_cost,life_book,life_page ";
      ...
      print "document.dialog.life_necessities.value = '"     . mysql_real_escape_string($a_lifestyle['life_necessities'])       . "';\n";
      ...
      print "document.dialog.life_space.value = '"           . mysql_real_escape_string($a_lifestyle['life_space'])             . "';\n";
