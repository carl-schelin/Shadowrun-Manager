...
<div id="dialogProjectile" title="Projectile">
...
<table class="ui-styled-table" width="100%">
<tr>
  <th class="ui-state-default" colspan="9">Projectile Weapon Form</th>
</tr>
<tr>
...
?>
  ...
  <td class="ui-widget-content" colspan="2">Name <input type="text" name="proj_name" size="20"></td>
...
<tr>
  ...
  <td class="ui-widget-content">Avail <input type="text" name="proj_avail" size="3"></td>
  <td class="ui-widget-content">Perm <input type="text" name="proj_perm" size="3"></td>
  <td class="ui-widget-content" colspan="2">Cost <input type="text" name="proj_cost" size="10"></td>
...
?>
  ...
  <td class="ui-widget-content">Page <input type="text" name="proj_page" size="3"></td>
</tr>
</table>
