<?php
# Script: add.spritepower.del.php
# Owner: Carl Schelin
...
# Description: 
  ...
  if (isset($_SESSION['username'])) {
    $package = "add.spritepower.del.php";
    $formVars['id'] = 0;
    if (isset($_GET['id'])) {
    ...
    if (check_userlevel(1)) {
      logaccess($_SESSION['username'], $package, "Deleting " . $formVars['id'] . " from sprite_powers");
      ...
      print "alert('Sprite Power deleted.');\n";
    } else {
