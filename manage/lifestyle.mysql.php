...
# Description:
  ...
  if (mysql_num_rows($q_r_lifestyle) > 0) {
    while ($a_r_lifestyle = mysql_fetch_array($q_r_lifestyle)) {
      ...
      $output .= "<td class=\"ui-widget-content delete\">" . number_format($a_r_gear['gear_cost'], 0, '.', ',') . $nuyen     . "</td>\n";
      $output .= "<td class=\"ui-widget-content delete\">" . $a_r_lifestyle['ver_book'] . ": " . $a_r_lifestyle['life_page'] . "</td>\n";
      $output .= "</tr>\n";
