...
# Description: Fill in the forms for editing
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel($db, $AL_Shadowrunner)) {
      logaccess($db, $_SESSION['username'], $package, "Requesting record " . $formVars['id'] . " from r_armor");
      ...
      print "document.getElementById('r_arm_item').innerHTML = '" . mysqli_real_escape_string($db, $arm_name)                      . "';\n\n";
      print "document.edit.r_arm_details.value = '"               . mysqli_real_escape_string($db, $a_r_armor['r_arm_details'])    . "';\n";
      print "document.edit.r_arm_number.value = '"                . mysqli_real_escape_string($db, $a_r_armor['r_arm_number'])     . "';\n";
