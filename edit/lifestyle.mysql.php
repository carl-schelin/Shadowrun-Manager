...
# if dwarf, * 1.2;
      ...
      $costtotal = 0;
      $q_string  = "select r_life_id,r_life_desc,r_life_months,life_id,life_style,life_comforts,life_security,life_neighborhood,life_entertainment,life_cost,ver_book,life_page ";
      $q_string .= "from r_lifestyle ";
      ...
      if (mysql_num_rows($q_r_lifestyle) > 0) {
        while ($a_r_lifestyle = mysql_fetch_array($q_r_lifestyle)) {
          ...
          $output .= "  <td class=\"" . $class . " delete\">"              . $a_r_lifestyle['life_comforts']                 . "</td>\n";
          $output .= "  <td class=\"" . $class . " delete\">"              . $a_r_lifestyle['life_security']                 . "</td>\n";
          $output .= "  <td class=\"" . $class . " delete\">"              . $a_r_lifestyle['life_neighborhood']             . "</td>\n";
          $output .= "  <td class=\"" . $class . " delete\">"              . $a_r_lifestyle['life_entertainment']            . "</td>\n";
        ...
        $output .= "<tr>\n";
        $output .= "  <td class=\"ui-widget-content\" colspan=\"10\">No Lifestyle selected.</td>\n";
        $output .= "</tr>\n";
      }
      $output .= "</table>\n";
