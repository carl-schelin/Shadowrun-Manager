...
# Description: Delete association entries
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel(3)) {
      ...
      $a_r_cyberdeck = mysql_fetch_array($q_r_commlink);
      ...
      $q_string .= "where sub_name = \"Cyberdecks\" and r_acc_character = " . $a_r_cyberdeck['r_deck_character'] . " and r_acc_parentid = " . $formVars['id'] . " ";
