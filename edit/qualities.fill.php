...
# Description: Fill in the forms for editing
  ...
  if (isset($_SESSION['username'])) {
    ...
    if (check_userlevel(3)) {
      logaccess($_SESSION['username'], $package, "Requesting record " . $formVars['id'] . " from r_qualities");
      ...
      $a_r_qualities = mysql_fetch_array($q_r_qualities);
      mysql_free_result($q_r_qualities);

      print "document.edit.r_qual_number.value = '"  . mysql_real_escape_string($a_r_qualities['r_qual_number'])  . "';\n";
      print "document.edit.r_qual_details.value = '" . mysql_real_escape_string($a_r_qualities['r_qual_details']) . "';\n";
